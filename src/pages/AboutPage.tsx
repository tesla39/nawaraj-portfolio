...
const AboutPage = () => {
  const skills = [{
    ...
    items: ["Python", "JavaScript", "TypeScript", "Node.js", "React", "Next.js"]
  }, {
    category: "Backend & Databases",
    items: ["PostgreSQL", "MongoDB", "REST APIs", "GraphQL", "gRPC", "Redis"]
  }, {
    category: "Tools & DevOps",
    items: ["Docker", "Git", "VS Code", "GitHub", "Linux", "CI/CD"]
  }, {
    category: "Architecture",
    items: ["OOP", "Design Patterns", "Microservices", "System Design"]
  }, {
    category: "Extras",
    items: ["AI Toolkits", "Testing", "WebSockets", "Performance Optimization"]
  }];
  return <div className="flex flex-col min-h-screen bg-deep-blue scroll-smooth">
      <Navbar />
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" alt="Working on designs" className="rounded-lg shadow-lg" />
                <div className="absolute -bottom-6 -left-6 p-6 rounded-lg shadow-xl max-w-xs bg-slate-700">
                  <blockquote className="text-lg italic">
                    "Code isn’t just what you write. It’s how the whole system works together."
                  </blockquote>
                  <p className="mt-2 font-medium text-right">—  John Carmack</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-background/30">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {skills.map((skillGroup, index) => <div key={index} className="p-6 rounded-xl shadow-md bg-gray-700">
